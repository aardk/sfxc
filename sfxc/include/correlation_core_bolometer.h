#ifndef CORRELATION_CORE_BOLOMETER_H_
#define CORRELATION_CORE_BOLOMETER_H_
...
class Correlation_core_bolometer : public Correlation_core {
public:
  Correlation_core_bolometer();
  virtual ~Correlation_core_bolometer();
...
protected:
  ...
  std::vector< std::vector< std::vector<float> > >  station_power;
private:
  int ffts_to_skip;
};
